...
Shader "New Amplify Shader"
{
	Properties
	{
		...
		_caoNormal("caoNormal", 2D) = "bump" {}
		_shitouNormal("shitouNormal", 2D) = "bump" {}
		_shitou("shitou", 2D) = "white" {}
		[ASEEnd]_cao("cao", 2D) = "white" {}
	...
	SubShader
	{
		...
		Pass
		{
			...
			sampler2D _shitou;
			sampler2D _cao;
			sampler2D _shitouNormal;
			sampler2D _caoNormal;


			inline float4 TriplanarSampling74( sampler2D topTexMap, sampler2D midTexMap, sampler2D botTexMap, float3 worldPos, float3 worldNormal, float falloff, float2 tiling, float3 normalScale, float3 index )
			{
						 ...
						 ) : SV_Target
			{
				...
				float4 triplanar74 = TriplanarSampling74( _shitou, _cao, _shitou, IN.ase_normal, WorldNormal, _FallOff, _Tiling, float3( 1,1,1 ), float3(0,0,0) );
				
				float4 triplanar73 = TriplanarSampling73( _shitouNormal, _caoNormal, _shitouNormal, WorldPosition, WorldNormal, _FallOff, _Tiling, float3( 1,1,1 ), float3(0,0,0) );
				
				float3 Albedo = triplanar74.xyz;
				float3 Normal = UnpackNormalScale( triplanar73, 1.0 );
				float3 Emission = 0;
				float3 Specular = 0.5;
				float Metallic = 0;
		...
		Pass
		{
			...
			half4 frag(VertexOutput IN  ) : SV_TARGET
			{
				...
				float4 triplanar74 = TriplanarSampling74( _shitou, _cao, _shitou, IN.ase_normal, ase_worldNormal, _FallOff, _Tiling, float3( 1,1,1 ), float3(0,0,0) );
...
/*ASEBEGIN
Version=18935
473;696;876;295;1764.226;-303.09;1.9;True;False
Node;AmplifyShaderEditor.RangedFloatNode;69;-1196.9,408.998;Float;False;Property;_FallOff;FallOff;0;0;Create;True;0;0;0;False;0;False;100;10;0;100;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;70;-1250.136,547.1313;Float;False;Property;_Tiling;Tiling;1;0;Create;True;0;0;0;False;0;False;1;0.2;0;10;0;1;FLOAT;0
Node;AmplifyShaderEditor.TexturePropertyNode;67;-884.5076,380.4294;Float;True;Property;_shitouNormal;shitouNormal;3;0;Create;True;0;0;0;True;0;False;2241fc28a25cf8740805626e543dcc80;None;True;bump;Auto;Texture2D;-1;0;2;SAMPLER2D;0;SAMPLERSTATE;1
Node;AmplifyShaderEditor.TexturePropertyNode;68;-943.7067,651.3869;Float;True;Property;_caoNormal;caoNormal;2;0;Create;True;0;0;0;True;0;False;98ddd81e85725ec409b3c1d5609e2392;None;True;bump;Auto;Texture2D;-1;0;2;SAMPLER2D;0;SAMPLERSTATE;1
Node;AmplifyShaderEditor.TexturePropertyNode;78;-1208.257,-62.9511;Float;True;Property;_shitou;shitou;4;0;Create;True;0;0;0;True;0;False;a8f1e16c1364ec64d887e63cf08e2dc3;None;False;white;Auto;Texture2D;-1;0;2;SAMPLER2D;0;SAMPLERSTATE;1
Node;AmplifyShaderEditor.NormalVertexDataNode;80;-1500.966,311.755;Inherit;False;0;5;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.TexturePropertyNode;79;-1214.757,134.6488;Float;True;Property;_cao;cao;5;0;Create;True;0;0;0;True;0;False;07587ced52bb0fa448c86e7a859dfa44;None;False;white;Auto;Texture2D;-1;0;2;SAMPLER2D;0;SAMPLERSTATE;1
Node;AmplifyShaderEditor.TriplanarNode;73;-644.8269,519.3771;Inherit;True;Cylindrical;World;False;Top Texture 1;_TopTexture1;white;2;None;Mid Texture 1;_MidTexture1;white;1;None;Bot Texture 1;_BotTexture1;white;3;None;Triplanar Sampler;Tangent;10;0;SAMPLER2D;;False;5;FLOAT;1;False;1;SAMPLER2D;;False;6;FLOAT;0;False;2;SAMPLER2D;;False;7;FLOAT;0;False;9;FLOAT3;0,0,0;False;8;FLOAT3;1,1,1;False;3;FLOAT;1;False;4;FLOAT;100;False;5;FLOAT4;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.UnpackScaleNormalNode;75;-65.1364,620.1313;Inherit;False;Tangent;2;0;FLOAT4;0,0,0,0;False;1;FLOAT;1;False;4;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3
Node;AmplifyShaderEditor.TriplanarNode;74;-896.8195,110.1461;Inherit;True;Cylindrical;World;False;Top Texture 0;_TopTexture0;white;2;None;Mid Texture 0;_MidTexture0;white;2;None;Bot Texture 0;_BotTexture0;white;3;None;Triplanar Sampler;Tangent;10;0;SAMPLER2D;;False;5;FLOAT;1;False;1;SAMPLER2D;;False;6;FLOAT;0;False;2;SAMPLER2D;;False;7;FLOAT;0;False;9;FLOAT3;0,0,0;False;8;FLOAT3;1,1,1;False;3;FLOAT;1;False;4;FLOAT;100;False;5;FLOAT4;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
